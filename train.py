    ...
    for epoch in range(hp.epochs):
        ...
        for idx, batch in enumerate(loader):
            ...
            total_loss = (mel_loss*mel_loss_weight +
                           mel_postnet_loss*mel_postnet_loss_weight +
                           d_loss*d_loss_weight + 
                           f_loss*f_loss_weight + 
                           e_loss*e_loss_weight)
            ...
            if accumulated_current_step % hp.eval_step == 0:
                ...
                with torch.no_grad():
                    ...
                    t_l = (m_l*mel_loss_weight +
                           m_p_l*mel_postnet_loss_weight +
                           d_l*d_loss_weight + 
                           f_l*f_loss_weight + 
                           e_l*e_loss_weight)
