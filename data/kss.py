...
def process_utterance(in_dir, out_dir, basename, scalers):
    ...
    wav_path = os.path.join(in_dir, basename[0], '{}.wav'.format(basename))
    tg_path = os.path.join(out_dir, '{}.TextGrid'.format(basename)) 
    ...
    print('------------------------------------------------------------------')
    print('before f0 : ', f0.shape)
    print('before energy : ', energy.shape)
    ...
    print('removed f0 : ', f0.shape)
    print('removed energy : ', energy.shape)
